...
<div>
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <div class="lg:hidden">
            <button v-on:click="toggleMenu" class="navbar-burger flex items-center text-blue-600 p-3">
    ...
    <div class="navbar-menu relative z-50" v-show="leftMenu">
        <div class="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25"></div>
        <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            <div class="flex items-center mb-8">
                <a class="mr-auto text-3xl font-bold leading-none" href="#">
                </a>
                <button class="navbar-close" v-on:click="toggleMenu">
                    <svg class="h-6 w-6 text-gray-400 cursor-pointer hover:text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
                <ul>
                    ...
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-bold text-gray-400 hover:bg-yellow-500 hover:text-white rounded" href="#">Contact</a>
                    </li>
                </ul>
            </div>
            <div class="mt-auto">
